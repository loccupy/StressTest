...
def relay_reconnect_connect(base_connect, emergency_connect, count, sleep_time_after_disconnect,
    ...
    # base_connect = Configuration.base_connect
    # emergency_connect = Configuration.emergency_connect
    relay = GXDLMSDisconnectControl("0.0.96.3.10.255")
    x = 1
    while x <= 3:
        # timeout_for_disconnect = Timeout(5, Exception)
